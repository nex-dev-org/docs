---
title: "Installation"
description: "How to install NEX.dev Loading Screen on your FiveM server."
---
...
1. Drop the `nexdev_loadingscreen` folder into your `resources/` directory. Any subfolder is fine, e.g. `resources/[nex]/nexdev_loadingscreen/`.

2. Add it to your `server.cfg`:

   ```
   ensure nexdev_loadingscreen
   ```
...
Connect to the server. You should see the NEX.dev loading screen with the animated background and music player.

From F8 (after spawning in):

```
lua print(GetResourceState('nexdev_loadingscreen'))
```
