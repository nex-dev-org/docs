---
title: "Commands"
description: "Commands and exports for NEX.dev Donator System."
---
...
There's also a configurable keybind (default `F9`) — see [Configuration](/nexdev_donatorsystem/configuration#open-command--keybind).
...
Both commands also have GUI equivalents in the admin panel's Player Management tab — see [Admin panel → Player Management](/nexdev_donatorsystem/admin-panel#player-management).
