---
title: "Installation"
description: "How to install NEX.dev Hotels on your FiveM server."
---
...
```
mysql -u <user> -p <database> < resources/[nex]/nexdev_hotels/imports/01_opium_nights_hotel.sql
```
...
You don't need an MLO. Stand anywhere, run `/hoteladmin`, click **+ New Hotel**, and follow the steps in [Admin panel](/nexdev_hotels/admin-panel). Players see new hotels and rooms instantly — no restart needed.
