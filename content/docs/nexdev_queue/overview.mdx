...
* [Installation](/nexdev_queue/installation)
* [Discord setup](/nexdev_queue/discord-setup)
* [Configuration](/nexdev_queue/configuration)
* [Themes](/nexdev_queue/themes)
* [Whitelist & priority](/nexdev_queue/whitelist-and-priority)
* [Troubleshooting](/nexdev_queue/troubleshooting)
...
<Callout type="info">
  ...
  New here? Start with [Installation](/nexdev_queue/installation), then walk through [Discord setup](/nexdev_queue/discord-setup) to wire up the bot.
