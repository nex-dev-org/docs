---
title: "Themes"
description: "NEX.dev Queue ships with 8 ready-made Adaptive Card themes. They all show the same information (position, priority, time, tier) — the layout is what changes. Pick the one that matches your community's…"
---

NEX.dev Queue ships with **8 ready-made Adaptive Card themes**. They all show the same information (position, priority, time, tier) — the layout is what changes. Pick the one that matches your community's look.
