---
title: "Configuration"
description: "Everything lives in shared/config.lua. Edit, then restart nexdev_animpos for changes to apply."
---

Everything lives in `shared/config.lua`. Edit, then `restart nexdev_animpos` for changes to apply.
