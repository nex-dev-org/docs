...
## Step 1 — Set your Tebex secret [#step-1-set-your-tebex-secret]
...
## Step 2 — Find each package's ID [#step-2-find-each-packages-id]
...
## Step 3 — Map packages to currency [#step-3-map-packages-to-currency]
...
## Step 4 — Optional fallback rate [#step-4-optional-fallback-rate]
...
## Step 5 — Restart and test [#step-5-restart-and-test]
