---
title: "Configuration"
description: "Two files. Edit them, then restart nexdev_donatorsystem."
---

Two files. Edit them, then `restart nexdev_donatorsystem`.
...
Tebex package mapping has its own page — see [Tebex setup](/nexdev_donatorsystem/tebex-setup).
...
## Open command + keybind [#open-command-keybind]
