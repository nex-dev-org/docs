---
title: "Installation"
description: "How to install NEX.dev Garages on your FiveM server."
---
...
[Integrations & exports](/nexdev_garages/integrations).

## Steps

1. Download the resource from your [Cfx.re Portal](https://portal.cfx.re/assets/granted-assets)
   granted assets and drop it into your server, e.g. `resources/[nex]/nexdev_garages/`.
...
4. Grant staff access for the admin commands with the dedicated ACE:

   ```
   add_ace group.admin nexdev_garages.admin allow
   ```

   The in-game garage editor also accepts the ACE groups from
...
```
lua print(GetResourceState('nexdev_garages'))
```
