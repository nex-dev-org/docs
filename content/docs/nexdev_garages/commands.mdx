...
| `/garagesadmin` | ACE groups in `CustomGarages.allowedGroups` | [In-game garage editor](/nexdev_garages/garage-editor) |
| `/privategarages` | Admins + `PrivateGarages.jobRestriction` jobs | [Private garage management](/nexdev_garages/private-garages) |
...
<Callout type="info">
  ...
  `add_ace group.admin nexdev_garages.admin allow` (configurable via `adminAce`
