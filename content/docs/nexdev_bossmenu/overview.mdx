...
* [Installation](/nexdev_bossmenu/installation)
* [Configuration](/nexdev_bossmenu/configuration)
* [Usage](/nexdev_bossmenu/usage)
* [Commands](/nexdev_bossmenu/commands)
* [Custom frameworks](/nexdev_bossmenu/custom-frameworks)
* [Troubleshooting](/nexdev_bossmenu/troubleshooting)
...
<Callout type="info">
  ...
  Migrating from the original 3.x build? The schema bootstrap atomically renames `boss_menu_locations` → `nexdev_bossmenu` on first boot — your placed markers carry over with no manual SQL.
