---
title: "Configuration"
description: "Everything lives in lua/config.lua. Edit, then restart nexdev_loadingscreen."
---

Everything lives in `lua/config.lua`. Edit, then `restart nexdev_loadingscreen`.

Music and asset paths have their own dedicated page — see [Music & assets](/nexdev_loadingscreen/music).
