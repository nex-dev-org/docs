...
| Command | What it does |
| --- | --- |
| `/djbooths` | Open the booth manager. |
| `/djcreate` | Alias of `/djbooths`. |
| `/djedit` | Alias of `/djbooths`. |
| `/djdelete` | Alias of `/djbooths`. |
| `/djcreator` | Alias of `/djbooths`. |

All five open the same panel — adding, editing and deleting are all done from it. See [Booth manager](/nexdev_djsystem/location-creator).
