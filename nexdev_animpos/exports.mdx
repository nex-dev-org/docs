---
title: "Exports"
description: "Client exports for integrating NEX.dev Anim Pos with other resources — menus, emote scripts, admin tools."
---

Client exports for integrating NEX.dev Anim Pos with other resources — menus, emote scripts, admin tools.

Resource name is `nexdev_animpos`. Both exports are **client-side**.
...
```lua
if exports.nexdev_animpos:CheckSit() then
...
```lua
-- Your menu opens:
exports.nexdev_animpos:DisableCommands(true)

-- Your menu closes:
exports.nexdev_animpos:DisableCommands(false)
```
