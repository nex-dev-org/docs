---
title: "Installation"
description: "How to install NEX.dev Elevators on your FiveM server."
---
...
1. Drop the `nexdev_elevators` folder into `resources/[nex]/`.
...
3. Add it to `server.cfg` **after** your framework and `ox_lib`:
   ...
   ensure nexdev_elevators
   ```

4. Restart your server. You should see something like `[nexdev_elevators] Imported 2 elevator(s) from config as defaults.` in the console.
