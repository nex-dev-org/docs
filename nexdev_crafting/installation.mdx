---
title: "Installation"
description: "How to install NEX.dev Crafting on your FiveM server."
---
...
1. Drop the `nexdev_crafting` folder into your resources, e.g. `resources/[nex]/nexdev_crafting/`.
...
5. Grant access to the creator panel. Either:
   ...
   …or rely on the default framework groups (`admin`, `superadmin`, `god`). Both are accepted out of the box — see [Configuration](/nexdev_crafting/configuration).
...
```
lua print(GetResourceState('nexdev_crafting'))
```
